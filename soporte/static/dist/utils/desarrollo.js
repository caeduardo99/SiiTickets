$(document).ready(function () {
  ...
  $("form").submit(function (event) {
    ...
    filasPrincipales.forEach(function (fila) {
      ...
      const responsableNombre = selectResponsable
        ? selectResponsable.options[selectResponsable.selectedIndex].text
        : "";
    ...
    $.post(form.attr("action"), form.serialize(), function (data) {
      ...
      if (data.status === "success") {
        ...
        let estadoNameTicket
        if(estadoTicket == 1){
          estadoNameTicket = 'Por asignar'
        }else{
          estadoNameTicket = 'En proceso'
        }
        ...
        var objGeneratePdf = {
          content: [
            ...
            {
              text:
                textDescripcionRequerimiento.value ||
            ...
            },
            {
              ul: [
                ...
                `Estado del proyecto: ${estadoNameTicket}`,
                `Horas completas del Proyecto: ${inputNumHorasCompletas.value} horas`,
              ],
            ...
            },
            {
              table: {
                ...
                widths: ["*", "*", "*"],
                body: [
                  ["Tarea principal", "Horas Asignadas", "Agente encargado"],
            ...
            },
            {
              table: {
                ...
                widths: ["*", "*", "*"],
                body: [
                  ["Tarea", "Horas diarias de trabajo", "Fecha de trabajo"],
    ...
    if (
      ...
      resultadosProyectos.forEach((proyecto) => {
        ...
        row.insertCell().textContent =
          proyecto.fechaFinalizacionEstimada == null
            ? "Sin asignar"
            : formatFecha(proyecto.fechaFinalizacionEstimada);
            ...
            .then(async (data) => {
              ...
              if (detalleTicket.length == 0) {
                ...
                detalleTicket.forEach((tarea) => {
                  ...
                  // CONDICION EN CASO DE QUE LOS ADMINS NECESITEN CAMBIAR DE AGENTE ASIGNADO
                  if (
                    nombreUsuario != "mafer" &&
      ...
      cell.innerHTML =
        "No hay proyectos a cargo o solicitados por el usuario actual.";
  ...
  btnGenerateReport.addEventListener("click", function () {
    const proyectoinfo = dataReport.infoGeneralProject;
    const tasksMain = dataReport.tasksMain;
    const tasksSecundary = dataReport.tasksSecundary;
  ...
  function makePdf(
    ...
    var objGeneratePdf = {
      content: [
        ...
        {
          text:
            textDescripcionRequerimiento.value || "No hay descripción del proyecto.",
          fontSize: 12,
          margin: [0, 5, 0, 5],
        },
        {
  ...
  // Metodo para la funcionalidad al escribir en la descripcion
  textDescripcionRequerimiento.addEventListener('input', function(){
    if(textDescripcionRequerimiento.value != ''){
