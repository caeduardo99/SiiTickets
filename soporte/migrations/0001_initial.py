# Generated by Django 3.2.23 on 2024-02-02 16:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ActividadPrincipalSoporte',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=255)),
                ('imagen_actividades', models.ImageField(blank=True, null=True, upload_to='ticket_images_soporte/')),
                ('fechainicio', models.DateTimeField(blank=True, null=True)),
                ('fechafinal', models.DateTimeField(blank=True, null=True)),
                ('idAgente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_act_agente', to=settings.AUTH_USER_MODEL)),
                ('idTicketSoporte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='soporte_tickets', to='soporte.ticketsoporte')),
                ('idestado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_act_estado', to='soporte.estadosticket')),
            ],
        ),
        migrations.CreateModel(
            name='ActividadPrincipalActualizacion',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=255)),
                ('horasDiariasAsignadas', models.IntegerField()),
                ('idAgente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_actualizacion_agente', to=settings.AUTH_USER_MODEL)),
                ('idTicketDesarrollo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='soporte.ticketactualizacion')),
                ('idestado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_actividad_actualizacion_estado', to='soporte.estadosticket')),
            ],
        ),
        migrations.AddField(
