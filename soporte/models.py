...
class ExtendedUser(AbstractUser):
    ...
    idEmpresa = models.ForeignKey(Empresa, on_delete=models.CASCADE, null=True, blank=True)
    idRol = models.ForeignKey(Rol, on_delete=models.CASCADE, null=True, blank=True)

class TicketActualizacion(models.Model):
    id = models.AutoField(primary_key=True)
    idAgente = models.ForeignKey(ExtendedUser, on_delete=models.CASCADE)
...
class TicketDesarrollo(models.Model):
    id = models.AutoField(primary_key=True)
    idAgente = models.ForeignKey(ExtendedUser, on_delete=models.CASCADE, related_name='ticket_desarrollo_agente')
    idSolicitante = models.ForeignKey(ExtendedUser, on_delete=models.CASCADE, related_name='ticket_desarrollo_solicitante')
...
class TicketSoporte(models.Model):
    id = models.AutoField(primary_key=True)
    idAgente = models.ForeignKey(ExtendedUser, on_delete=models.CASCADE, related_name='ticket_soporte_agente')
    idSolicitante = models.ForeignKey(ExtendedUser, on_delete=models.CASCADE, related_name='ticket_soporte_solicitante')
    fechaCreacion = models.DateTimeField(auto_now_add=True)
    fechaInicio = models.DateTimeField(auto_now_add=True)
    fechaFinalizacion = models.DateTimeField(auto_now_add=True)
    fechaFinalizacionReal = models.DateTimeField(auto_now_add=True)
