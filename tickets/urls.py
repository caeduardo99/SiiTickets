...
urlpatterns = [
    ...
    path('asign_admin_ticket_support/<int:id_agente>/<int:id_ticket>/<int:id_user_modified>/', views.asign_admin_ticket_support, name='asign_admin_ticket_support'),
    ...
    path('cerrar_ticket/<int:id_ticket>/<int:id_usuario_modified>/',views.cerrar_ticket, name='cerrar_ticket'),
    ...
    path('null_ticket/<int:id_ticket>/<int:id_estado>', views.null_ticket, name='null_ticket'),
